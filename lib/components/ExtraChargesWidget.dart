                                  ...
                                  if (extraController.text.isNotEmpty) {
                                    if (list.isNotEmpty) {
                                      if (list.any((element) => element.key == extraCharges)) {
                                        ...
                                        list.remove(data);
                                        list.add(ExtraChargeRequestModel(key: extraCharges, value: num.parse(extraController.text.trim())));
                                      } else {
                                        list.add(ExtraChargeRequestModel(key: extraCharges, value: num.parse(extraController.text.trim())));
                                      }
                                    } else {
                                    ...
                                    toast(language.pleaseAddAmount);
                                  }
                                } else {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(child: Text(language.amount, style: boldTextStyle())),
                                Spacer(),
                              ],
                            ),
                            SizedBox(height: 8),
                              ...
                              children: list.map((e) {
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: printAmountWidget(amount: e.value!.toStringAsFixed(digitAfterDecimal), weight: FontWeight.normal),
                                    ),
                                    Expanded(
                                      child: inkWellWidget(
                                        onTap: () {
                        ...
                        children: [
                          Expanded(
                            child: AppButtonWidget(
                              ...
                              onTap: () {
                                if (list.isEmpty) {
                                  return toast(language.pleaseSelectExtraCharges);
                                }
