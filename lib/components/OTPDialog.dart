  ...
  return showDialog<T>(
    ...
    builder: (_) => AlertDialog(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: neonAccent.withOpacity(0.45)),
      ),
...
class OTPDialogState extends State<OTPDialog> {
        ...
        if (value.data == null) {
          ...
          launchScreen(
            ...
            SignUpScreen(
              ...
              userName: national,
              socialLogin: true,
              privacyPolicyUrl: kDefaultZigoPrivacyPolicyUrl,
              termsConditionUrl: kDefaultZigoTermsUrl,
            ),
          );
        } else {
          updatePlayerId();
  ...
  Future<void> sendOTP() async {
    ...
    try {
      await authService.loginWithOTP(context, parsed);
    } catch (e) {
      toast(e.toString());
      appStore.setLoading(false);
    }
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                icon: Icon(Icons.cancel_outlined, color: neonHighlight),
              )
            ],
          ),
          SizedBox(height: 30),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('+51', style: primaryTextStyle(color: neonHighlight)),
                        ],
                      ),
                    ),
            ...
            children: [
              Align(
                ...
                child: InkWell(
                    ...
                    child: Icon(Icons.cancel_outlined, color: neonHighlight)),
              ),
              Icon(Icons.message, color: neonAccent, size: 50),
              SizedBox(height: 16),
              Text(language.validateOtp, style: boldTextStyle(size: 18, color: appTextPrimaryColorWhite)),
              SizedBox(height: 16),
              Column(
                children: [
                  Text(language.otpCodeHasBeenSentTo, style: secondaryTextStyle(size: 16, color: neonHighlight), textAlign: TextAlign.center),
                  SizedBox(height: 4),
                  Text(widget.phoneNumber.validate(), style: boldTextStyle(color: neonAccent)),
                  SizedBox(height: 10),
                  Text(language.pleaseEnterOtp, style: secondaryTextStyle(size: 16, color: neonHighlight), textAlign: TextAlign.center),
                ],
              ),
              SizedBox(height: 16),
              SingleChildScrollView(
                ...
                child: Directionality(
                  ...
                  child: Pinput(
                    ...
                    cursor: Text(
                      "|",
                      style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500, color: neonAccent),
                    ),
                    focusedPinTheme: PinTheme(
                      ...
                      decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.all(Radius.circular(8)), border: Border.all(color: neonAccent, width: 1.5)),
                    ),
                    toolbarEnabled: true,
                    ...
                    defaultPinTheme: PinTheme(
                      ...
                      decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.all(Radius.circular(8)), border: Border.all(color: neonAccent.withOpacity(0.45))),
                    ),
