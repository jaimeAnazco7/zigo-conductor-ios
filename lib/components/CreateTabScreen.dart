    ...
    return inkWellWidget(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: neonAccent.withOpacity(0.42), width: 1),
          ...
          children: [
            Row(
              ...
              children: [
                Row(
                  children: [
                    Icon(Ionicons.calendar, color: neonHighlight, size: 16),
                    SizedBox(width: 4),
                    Padding(
                      padding: EdgeInsets.only(top: 2),
                      child: Text('${printDate(data.createdAt.validate())}', style: primaryTextStyle(color: neonHighlight, size: 14)),
                    ),
                  ],
                ),
                Text('${language.rideId} #${data.id}', style: boldTextStyle(color: Colors.white, size: 14)),
              ],
            ),
            Divider(height: 20, thickness: 1, color: neonAccent.withOpacity(0.22)),
            Expanded(
              child: Column(
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Expanded(child: Text(data.startAddress.validate(), style: primaryTextStyle(color: Colors.white, size: 14), maxLines: 2)),
                    ],
                  ),
                  SizedBox(height: 2),
                  Row(
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Expanded(child: Text(data.endAddress.validate(), style: primaryTextStyle(color: Colors.white, size: 14), maxLines: 2)),
                    ],
                  ),
                ],
              ),
