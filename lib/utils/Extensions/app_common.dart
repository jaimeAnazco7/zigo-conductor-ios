...
export 'SafeScaffoldBottomBar.dart';
...
MaterialColor createMaterialColor(Color color) {
  ...
  // Evitar color.value (deprecado / distinto según versión de Flutter).
  final int argb = 0xFF000000 | ((color.red & 0xFF) << 16) | ((color.green & 0xFF) << 8) | (color.blue & 0xFF);
