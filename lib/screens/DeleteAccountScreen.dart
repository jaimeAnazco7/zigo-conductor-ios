        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Text(language.areYouSureYouWantPleaseReadAffect, style: primaryTextStyle(color: neonHighlight, size: 15)),
                SizedBox(height: 16),
                Text(language.account, style: boldTextStyle(color: Colors.white)),
                SizedBox(height: 8),
                Text(language.deletingAccountEmail, style: primaryTextStyle(color: Colors.white)),
                SizedBox(height: 24),
                Center(
