                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 8),
                                  printAmountWidget(amount: totalAmount.toStringAsFixed(digitAfterDecimal), size: 22, color: Colors.white)
                                ],
                              ),
                            ),
                          ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(language.withDraw, style: boldTextStyle(size: 14)),
                                          SizedBox(height: 4),
                                    ...
                                    child: AppButtonWidget(
                                      ...
                                      onTap: () async {
                                        if (addMoneyController.text.isNotEmpty) {
                                          await withDrawRequest(amount: num.parse(addMoneyController.text));
                                        } else {
