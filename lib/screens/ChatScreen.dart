            ...
            children: [
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Icon(Icons.arrow_back, color: neonHighlight),
                ),
              ),
              SizedBox(width: 8),
              if (widget.show_history != true)
              ...
              if (widget.show_history != true)
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 16),
                  child: Text(widget.userData!.firstName.validate().capitalizeFirstLetter() + " ${widget.userData!.lastName.validate()}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              if (widget.show_history == true)
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 16),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: secondaryTextStyle(color: neonHighlight.withOpacity(0.7)),
                        ...
                        inkWellWidget(
                          child: Icon(Icons.send, color: neonAccent, size: 25),
                          onTap: () {
                            sendMessage();
                          },
                        )
