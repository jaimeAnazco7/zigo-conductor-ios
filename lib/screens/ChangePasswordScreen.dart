              ...
              child: Column(
                ...
                children: [
                  AppTextField(
                    ...
                    decoration: inputDecorationNeonForm(context, label: language.oldPassword),
                  ...
                  AppTextField(
                    ...
                    cursorColor: neonAccent,
                    textStyle: primaryTextStyle(color: Colors.white),
                    decoration: inputDecorationNeonForm(context, label: language.newPassword),
                    errorThisFieldRequired: language.thisFieldRequired,
                    errorMinimumPasswordLength: language.passwordInvalid,
                  ),
                  SizedBox(height: 16),
                  AppTextField(
                    ...
                    cursorColor: neonAccent,
                    textStyle: primaryTextStyle(color: Colors.white),
                    decoration: inputDecorationNeonForm(context, label: language.confirmPassword),
                    errorThisFieldRequired: language.thisFieldRequired,
                    errorMinimumPasswordLength: language.passwordInvalid,
                    validator: (val) {
